...
public class TaskResolver {
  ...
  @GraphQLMutation(
      ...
      description =
          "This endpoint deletes an aggregation of Tasks and returns the deleted Tasks. Filters can"
              + " be applied.")
  public DeleteTasksPayload deleteTasks(TaskQueryFilterParameter filterParameter)
    ...
    return new DeleteTasksPayload("Tasks successfully deleted", taskIdsToDelete);
  }
  ...
  public CreateTaskPayload createTask(
    ...
    return new CreateTaskPayload("Task successfully created", taskModelAssembler.toModel(task));
  }
  ...
  public UpdateTaskPayload updateTask(
    ...
    return new UpdateTaskPayload("Task successfully updated", taskModelAssembler.toModel(task));
  }
}
