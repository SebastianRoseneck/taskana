 ...
 * pro.taskana.task.graphql.resolvers.TaskResolver#claimTask claimTask} mutation.
 */
@GraphQLType(description = "Payload used as a return type for the claimTask mutation.")
public class ClaimTaskPayload {
  ...
  @GraphQLQuery(description = "The ID of the claimed Task.")
  public String getId() {
    return id;
  }
}
