...
@GraphQLType(
    description =
        "An Attachment offers the possibility of providing  further information to Tasks.This is a"
            + " specific short model-object which only requires the most important information.")
