...
/** Resolver for all {@linkplain Classification} related Queries. */
@GraphQLApi
@Service
public class ClassificationResolver {
  ...
  public ClassificationRepresentationModel getClassification(
    ...
    return classificationModelAssembler.toModelWithoutLinks(classification);
  }
  ...
  public CreateClassificationPayload createClassification(
    ...
    return new CreateClassificationPayload(
        ...
        classificationModelAssembler.toModelWithoutLinks(classification));
  }
